...
public class Dwarf extends Race{
    ...
    private final MonsterEnum[] fullAttack = {MonsterEnum.GIGANTE,MonsterEnum.DRAGÃO};
    private final MonsterEnum[] halfAttack = {MonsterEnum.BANDIDO, MonsterEnum.FANTASMA, MonsterEnum.ZUMBI};
