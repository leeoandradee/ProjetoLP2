...
public class Elf extends Race{
    ...
    private final MonsterEnum[] fullAttack = {MonsterEnum.BANDIDO,MonsterEnum.GIGANTE};
    private final MonsterEnum[] halfAttack = {MonsterEnum.DRAGÃO, MonsterEnum.FANTASMA, MonsterEnum.ZUMBI};
